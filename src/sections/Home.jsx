...
const glowVariants = {
  ...
  hover: {
    ...
    y: -3,
    filter:
      "drop-shadow(0 0 8px rgba(138,43,226,0.9)) drop-shadow(0 0 18px rgba(16,185,129,0.8))",
...
export default function Home() {
      ...
      <div className="relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center h-full text-center lg:text-left">
          <div className="w-full lg:pr-24 mx-auto max-w-3xl">
            ...
            {/* Heading */}
            <motion.h1
              className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-transparent bg-clip-text bg-linear-to-r from-[#1cd8d2] via-[#00b8ff] to-[#302b63] drop-shadow-lg"
            ...
            >
              <a
                href="#projects"
                className="px-6 py-3 rounded-full font-medium text-lg text-white bg-linear-to-r from-[#1cd8d2] via-[#00b8ff] to-[#302b63] shadow-lg hover:scale-105 transition-all"
              >
                View My Work →
              </a>
  ...
  <div
    className="
      absolute 
      w-80 md:w-105 lg:w-130
      h-80 md:h-105 lg:h-130
      rounded-full
      bg-linear-to-r from-[#1cd8d2] via-[#00b8ff] to-[#302b63]
      opacity-40
      blur-[120px]
      animate-pulse
    "
  ...
  src={avator}
  alt="Avatar"
  className="relative h-92.5 md:h-115 lg:h-150 w-auto object-contain z-10"
  initial={{ opacity: 0, y: 40 }}
  animate={{ opacity: 1, y: 0 }}
  transition={{ duration: 1 }}
/>
